...
<div>
   ...
   <button type="button" class="btn btn-primary" data-bs-toggle="modal"
      ...
      onclick="add_private()">Open modal for @mdo</button>
   ...
   <div class="container-fluid favorite" id="privateBlock">
      ...
      <br> 훈련이름 <input type="text"><br> 훈련종류 <label><input
         type="radio" name="train" value="기본명령훈련" checked="checked">기본명령훈련</label>
