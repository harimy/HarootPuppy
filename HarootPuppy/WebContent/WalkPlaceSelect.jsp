...
function goBack()
{
		...
		window.opener.document.getElementById("pet_fav_place").value = addr;
		window.opener.document.getElementById("pet_fav_lat").value = document.getElementById("lat").value;
		window.opener.document.getElementById("pet_fav_lng").value = document.getElementById("lng").value;
		window.close();
