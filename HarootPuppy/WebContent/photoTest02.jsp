...
<%
   ...
   // 실제 물리적 주소
   System.out.println("root를 찾아라" + root);   // web 에서 실행하고 console 창에서 확인
   ...
   // 확인
   System.out.println("path를 찾아" + path);
   ...
   try
   {
      ...
      out.println("이름 : " + request.getParameter("pet_photo") + "<br>");
      out.println("서버에 저장된 파일명 : " + req.getFilesystemName("upload") + "<br>");
      out.println("파일 타입 : " + req.getContentType("upload") + "<br>");
      
      String test = req.getParameter("upload");
      System.out.println("메롱:"+test);
       String photoName= req.getFilesystemName("upload");
       File file = req.getFile("upload");
         if(file != null)
            out.println("파일길이 : "+ file.length() + "<br>");

       realPath = path + "/" + photoName;
   }
   catch(Exception e)
   {
...
<body>
	<img src= "<%=realPath%>">
	<img src= "<%=cp %>../../.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/HarootPuppy/pds/File.separatorsaveData/IMG_7341.HEIC">
</body>
</html>
