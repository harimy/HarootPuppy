...
<head>
<meta charset="UTF-8">
<title>DiaryClinicInjectionInsertForm.jsp</title>
<style type="text/css">
...
<body>
	...
	<!-----------------------------
  DiaryClinicInjectioinInsertForm.jsp
  - 다이어리 진료(접종) 부분 
------------------------------->
...
<div>
	...
	<div>
		...
		<form action="" id="">
			...
			<!-- 접종 종류  -->
			<div class="form-group injectionType">
				<label for="focusedInput"> 
				<span class="input-group-text" >접종 종류</span>
				</label> 
				<select name="injection">
					<option value="injectType1">광견병</option>
					<option value="injectType2">종합백신</option>
					<option value="injectType3">켄넬코프</option>
					<option value="injectType4">코로나</option>
					<option value="injectType5">인플루엔자</option>
				</select>
			</div>
