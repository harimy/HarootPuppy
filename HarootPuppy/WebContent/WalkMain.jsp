...
<div style="width: 100%;">
		<table style="width: 100%; text-align: center;">
			...
			<tr>
				<td style="width: 300px; height: 280px; padding-left: 40px; padding-right: 40px;">
				...
				<td>
				<img class = "Image" src="/HarootPuppy/images/coco.png" style="width: 380px; height:280px; padding-right: 40px; padding-left: 40px;"> 
				</td>
			</tr>
			<tr>	
...
<div>
	<table border="1" style="width: 100%; text-align: center;">
		...
		<tr>
			...
			<td>
				<label for="big">
				<input type="checkBox" name="checkGroup" id="big" value="big">&nbsp;대형견
				</label>
				<label for="midium">
				<input type="checkBox" name="checkGroup" id="midium" value="midiun">&nbsp;중형견
				</label>
				<label for="small">
				<input type="checkBox" name="checkGroup" id="small" value="small">&nbsp;소형견
				</label>
			</td>
		</tr>
		<tr>
			...
			<td>
				<label for="necc">
				<input type="radio" name="necc" id="necc" value="necc">&nbsp;필수
				</label>
				<label for="neccdontcare">
				<input type="radio" name="necc" id="neccdontcare" value="neccdontcare">&nbsp;상관없음
				</label>
			</td>
		</tr>	
		<tr>
			...
			<td>
				<label for="noBite">
				<input type="radio" name="bite" id="noBite" value="no">&nbsp;입질 없는 반려견만
				</label>
				<label for="bitedontcare">
				<input type="radio" name="bite" id="bitedontcare" value="bitedontcare">&nbsp;상관없음
				</label>
			</td>
		</tr>	
		<tr>
			...
			<td>
				<label for="sameSex">
				<input type="radio" name="sex" id="sameSex" value="same">&nbsp;동일 성별만
				</label>
				<label for="sexdontcare">
				<input type="radio" name="sex" id="sexdontcare" value="sexdontcare">&nbsp;상관없음
				</label>
			</td>
		</tr>	
	</table>
