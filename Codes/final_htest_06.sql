...
, SID_CODE      VARCHAR2(30)    NOT NULL
, PAUSE_START   DATE            DEFAULT SYSDATE
...
INSERT INTO TBL_PAUSE(PAUSE_CODE, SID_CODE, PASUE_START) 
...
, '1', '2', '1', '1', '1'
, 2, 3
, TO_DATE('2021-06-29 13:30:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2021-06-29 14:30:00', 'YYYY-MM-DD HH24:MI:SS')
, '강쥐들과 짧고 굵게 뛰실 분?', '빡세게하실분 구합니다.', '뚝섬유원지', '37.529217', '127.071225'
, TO_DATE('2021-06-28 21:19:12', 'YYYY-MM-DD HH24:MI:SS'));
--==>> 1 행 이(가) 삽입되었습니다. 
...
, '1', '3', '1', '0', '1'
, 3, 4
, TO_DATE('2021-06-29 19:00:00', 'YYYY-MM-DD HH24:MI:SS'), TO_DATE('2021-06-29 20:30:00', 'YYYY-MM-DD HH24:MI:SS')
, '힐링 산책해요~!', '무리는 하지 않습니다..', '서울숲', '37.544319', '127.037723'
, TO_DATE('2021-06-28 22:01:12', 'YYYY-MM-DD HH24:MI:SS'));
--==>> 1 행 이(가) 삽입되었습니다. 
-------------------------------------------
...
2	SID002	1	3	1	0	0	3	4	21/06/27	21/06/27	가취가욥~!	프로산책러입니다	철산한신아파트 106동 놀이터 앞	37.473677	126.874963 	21/06/27
3	SID007	0	1	1	0	1	2	4	21/06/27	21/06/27	감성산책	울애기 착해요	올림픽대로 옆 놀이터	37.448685	132.871343	21/06/27
4	SID008	1	2	0	1	0	2	4	21/06/27	21/06/27	함께 산책 하실 분?	같이가요ㅎ	안양천 철산-가산 돌다리 앞	37.475694	126.876208	21/06/27
5	SID001	1	2	1	1	1	2	3	21/06/29	21/06/29	강쥐들과 짧고 굵게 뛰실 분?	빡세게하실분 구합니다.	뚝섬유원지	37.529217	127.071225	21/06/28
6	SID003	1	3	1	0	1	3	4	21/06/29	21/06/29	힐링 산책해요~!	무리는 하지 않습니다..	서울숲	37.544319	127.037723	21/06/28
*/
...
----------(0704 더미데이터 추가)---------------
INSERT INTO TBL_PARTICIPANTS(PARTICIPANTS_CODE, WALKROOM_CODE,  RELATION_CODE, PARTICIPANTS_START)
VALUES('PAR008', '5', 'REL003', TO_DATE('2021-06-28 21:19:12', 'YYYY-MM-DD HH24:MI:SS'));
--==>> 1 행 이(가) 삽입되었습니다.
INSERT INTO TBL_PARTICIPANTS(PARTICIPANTS_CODE, WALKROOM_CODE,  RELATION_CODE, READYOPTION_CODE, READYSTATE_CODE, PARTICIPANTS_START)
VALUES('PAR009', '5', 'REL004', 1, 1, TO_DATE('2021-06-28 22:15:45', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TBL_PARTICIPANTS(PARTICIPANTS_CODE, WALKROOM_CODE,  RELATION_CODE, READYOPTION_CODE, READYSTATE_CODE, PARTICIPANTS_START)
VALUES('PAR010', '5', 'REL001', 0, 1, TO_DATE('2021-06-28 23:34:34', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TBL_PARTICIPANTS(PARTICIPANTS_CODE, WALKROOM_CODE,  RELATION_CODE, READYOPTION_CODE, READYSTATE_CODE, PARTICIPANTS_START)
VALUES('PAR011', '5', 'REL005', 1, 0, TO_DATE('2021-06-28 23:37:31', 'YYYY-MM-DD HH24:MI:SS'));

INSERT INTO TBL_PARTICIPANTS(PARTICIPANTS_CODE, WALKROOM_CODE,  RELATION_CODE, PARTICIPANTS_START)
VALUES('PAR012', '6', 'REL002', TO_DATE('2021-06-28 22:01:13', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TBL_PARTICIPANTS(PARTICIPANTS_CODE, WALKROOM_CODE,  RELATION_CODE, READYOPTION_CODE, READYSTATE_CODE, PARTICIPANTS_START)
VALUES('PAR013', '6', 'REL006', 1, 0, TO_DATE('2021-06-28 23:27:11', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TBL_PARTICIPANTS(PARTICIPANTS_CODE, WALKROOM_CODE,  RELATION_CODE, READYOPTION_CODE, READYSTATE_CODE, PARTICIPANTS_START)
VALUES('PAR014', '6', 'REL007', 1, 0, TO_DATE('2021-06-28 23:45:31', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TBL_PARTICIPANTS(PARTICIPANTS_CODE, WALKROOM_CODE,  RELATION_CODE, READYOPTION_CODE, READYSTATE_CODE, PARTICIPANTS_START)
VALUES('PAR015', '6', 'REL008', 0, 1, TO_DATE('2021-06-28 23:56:00', 'YYYY-MM-DD HH24:MI:SS'));
--==>> 1 행 이(가) 삽입되었습니다. * 7 
-------------------------------------------

UPDATE TBL_PARTICIPANTS
SET READYSTATE_CODE = 1
WHERE PARTICIPANTS_CODE = 'PAR014';
...
-- 58. TBL_WALK_COMMENT : 산책방 댓글TBL_WALK_COMMENT : 산책방 댓글
...
----------(더미데이터추가 0704)------------------
INSERT INTO TBL_MATCH(MATCH_CODE, WALKROOM_CODE, MATCH_DATE)
VALUES('MAT003', 5, TO_DATE('2021-06-29 23:59:00', 'YYYY-MM-DD HH24:MI:SS'));
INSERT INTO TBL_MATCH(MATCH_CODE, WALKROOM_CODE, MATCH_DATE)
VALUES('MAT004', 6, TO_DATE('2021-06-30 00:30:11', 'YYYY-MM-DD HH24:MI:SS'));
--==>> 1 행 이(가) 삽입되었습니다. * 2
---------------------------------------------
SELECT *
FROM TBL_MATCH;
...
----------(더미데이터추가 0704)------------------
INSERT INTO TBL_EVALUATION(EVAL_CODE, MATCH_CODE, EVAL_WRITER, EVAL_TARGET, EVAL_SCORE1, EVAL_SCORE2, EVAL_SCORE3, EVAL_SCORE4)
VALUES ('EVAL005', 'MAT003', 'PAR008', 'PAR009', 70, 75, 70, 90);
INSERT INTO TBL_EVALUATION(EVAL_CODE, MATCH_CODE, EVAL_WRITER, EVAL_TARGET, EVAL_SCORE1, EVAL_SCORE2, EVAL_SCORE3, EVAL_SCORE4)
VALUES ('EVAL006', 'MAT003', 'PAR008', 'PAR010', 90, 75, 80, 90);
INSERT INTO TBL_EVALUATION(EVAL_CODE, MATCH_CODE, EVAL_WRITER, EVAL_TARGET, EVAL_SCORE1, EVAL_SCORE2, EVAL_SCORE3, EVAL_SCORE4)
VALUES ('EVAL007', 'MAT003', 'PAR008', 'PAR011', 85, 80, 85, 90);
INSERT INTO TBL_EVALUATION(EVAL_CODE, MATCH_CODE, EVAL_WRITER, EVAL_TARGET, EVAL_SCORE1, EVAL_SCORE2, EVAL_SCORE3, EVAL_SCORE4)
VALUES ('EVAL008', 'MAT004', 'PAR009', 'PAR008', 80, 90, 80, 70);
INSERT INTO TBL_EVALUATION(EVAL_CODE, MATCH_CODE, EVAL_WRITER, EVAL_TARGET, EVAL_SCORE1, EVAL_SCORE2, EVAL_SCORE3, EVAL_SCORE4)
VALUES ('EVAL009', 'MAT004', 'PAR009', 'PAR010', 90, 90, 80, 70);
INSERT INTO TBL_EVALUATION(EVAL_CODE, MATCH_CODE, EVAL_WRITER, EVAL_TARGET, EVAL_SCORE1, EVAL_SCORE2, EVAL_SCORE3, EVAL_SCORE4)
VALUES ('EVAL010', 'MAT004', 'PAR009', 'PAR011', 95, 90, 80, 80);
-------------------------------------------------

UPDATE TBL_EVALUATION
SET MATCH_CODE='MAT003'
WHERE EVAL_CODE='EVAL010';
...
-------0704 더미데이터 추가
INSERT INTO TBL_WALK_SCORE(WALK_SCORE_CODE, SID_CODE, REWARD_CODE, WALK_SCORE_DATE)
VALUES('SCORE004' , 'SID009', 4, TO_DATE('2021-06-30', 'YYYY-MM-DD'));
INSERT INTO TBL_WALK_SCORE(WALK_SCORE_CODE, SID_CODE, REWARD_CODE, WALK_SCORE_DATE)
VALUES('SCORE005' , 'SID010', 4, TO_DATE('2021-06-30', 'YYYY-MM-DD'));
--==>> 1 행 이(가) 삽입되었습니다. * 2
INSERT INTO TBL_WALK_SCORE(WALK_SCORE_CODE, SID_CODE, EVAL_CODE, WALK_SCORE_DATE)
VALUES('SCORE006' , 'SID006', 'EVAL005', TO_DATE('2021-06-30', 'YYYY-MM-DD'));
INSERT INTO TBL_WALK_SCORE(WALK_SCORE_CODE, SID_CODE, EVAL_CODE, WALK_SCORE_DATE)
VALUES('SCORE007' , 'SID002', 'EVAL006', TO_DATE('2021-06-30', 'YYYY-MM-DD'));
INSERT INTO TBL_WALK_SCORE(WALK_SCORE_CODE, SID_CODE, EVAL_CODE, WALK_SCORE_DATE)
VALUES('SCORE008' , 'SID007', 'EVAL007', TO_DATE('2021-06-30', 'YYYY-MM-DD'));
INSERT INTO TBL_WALK_SCORE(WALK_SCORE_CODE, SID_CODE, EVAL_CODE, WALK_SCORE_DATE)
VALUES('SCORE009' , 'SID001', 'EVAL008', TO_DATE('2021-06-30', 'YYYY-MM-DD'));
INSERT INTO TBL_WALK_SCORE(WALK_SCORE_CODE, SID_CODE, EVAL_CODE, WALK_SCORE_DATE)
VALUES('SCORE010' , 'SID002', 'EVAL009', TO_DATE('2021-06-30', 'YYYY-MM-DD'));
INSERT INTO TBL_WALK_SCORE(WALK_SCORE_CODE, SID_CODE, EVAL_CODE, WALK_SCORE_DATE)
VALUES('SCORE011' , 'SID007', 'EVAL010', TO_DATE('2021-06-30', 'YYYY-MM-DD'));
--==>> 1 행 이(가) 삽입되었습니다. * 6
-------------------------
...
INSERT INTO TBL_DAILY(DAILY_CODE, RELATION_CODE, DAILY_DAT)
...
INSERT INTO TBL_SURGERY(SURGERY_CODE, HOSPITAL_CODE, COMMON_CODE, SURGERY_NAME, SURGERY_COSE, SURGERY_NEXT)
