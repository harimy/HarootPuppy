...
ALTER TABLE TBL_PET ADD PET_FAV_LAT VARCHAR2(20);
--==>> Table TBL_PET이(가) 변경되었습니다.

ALTER TABLE TBL_PET ADD PET_FAV_LNG VARCHAR2(20);
--==>> Table TBL_PET이(가) 변경되었습니다.

-- 자주가는 산책 장소 경도, 위도 데이터 추가
UPDATE TBL_PET
SET PET_FAV_LAT='37.479297', PET_FAV_LNG='126.873980'
WHERE PET_CODE='PET001';

UPDATE TBL_PET
SET PET_FAV_LAT='37.469857', PET_FAV_LNG='126.876329'
WHERE PET_CODE='PET002';

UPDATE TBL_PET
SET PET_FAV_LAT='37.517450', PET_FAV_LNG='126.958839'
...
UPDATE TBL_PET
SET PET_FAV_LAT='37.281934', PET_FAV_LNG='127.013726'
WHERE PET_CODE='PET005';

UPDATE TBL_PET
SET PET_FAV_LAT='37.551573', PET_FAV_LNG='126.925088'
WHERE PET_CODE='PET006';

UPDATE TBL_PET
SET PET_FAV_LAT='37.565984', PET_FAV_LNG='126.919661'
WHERE PET_CODE='PET007';

UPDATE TBL_PET
SET PET_FAV_LAT='35.157150', PET_FAV_LNG='129.154151'
WHERE PET_CODE='PET008';

UPDATE TBL_PET
SET PET_FAV_LAT='37.479063', PET_FAV_LNG='126.874707'
WHERE PET_CODE='PET009';
--==>> 1 행 이(가) 업데이트되었습니다. * 9

-- NOT NULL 제약사항 추가( NOT NULL 제약조건은 컬럼 추가와 동시에 할 수 없음 )
ALTER TABLE TBL_PET MODIFY PET_FAV_LAT NOT NULL;
ALTER TABLE TBL_PET MODIFY PET_FAV_LNG NOT NULL;
--==>> Table TBL_PET이(가) 변경되었습니다.
