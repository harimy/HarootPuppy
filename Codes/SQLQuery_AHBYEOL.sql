...
SELECT NOTICE_CODE, NOTICE_WRITER, NOTICE_HEAD_CODE
		...
		WHERE NOTICE_CODE = 1
        ;
--==>> 1	ADM001	2	필독	강아지배변봉투		산책 시 강아지 배변봉투를 꼭 챙겨주세요	0	0	2021-06-26
...
UPDATE TBL_NOTICE
SET NOTICE_HEAD_CODE = 1, NOTICE_TITLE = '수정햇삼', NOTICE_CONTENT='수정한 내용'
WHERE NOTICE_CODE = 11
;
